...
* Spark 2.4.0 for Hadoop 3.1 with OpenJDK 8
...
To start a Spark worker:
    ...
    docker run --name spark-worker-1 --link spark-master:spark-master -e ENABLE_INIT_DAEMON=false -d bde2020/spark-worker:2.4.0-hadoop3.1
