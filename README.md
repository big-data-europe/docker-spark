...
* Spark 2.4.0 for Hadoop 3.0 with OpenJDK 8
* Spark 2.4.0 for Hadoop 2.8 with OpenJDK 8
* Spark 2.4.0 for Hadoop 2.7 with OpenJDK 8
* Spark 2.3.2 for Hadoop 2.8 with OpenJDK 8
...
```yml
spark-master:
  image: bde2020/spark-master:2.4.0-hadoop3.0
...
spark-worker-1:
  image: bde2020/spark-worker:2.4.0-hadoop3.0
...
To start a Spark master:
    ...
    docker run --name spark-master -h spark-master -e ENABLE_INIT_DAEMON=false -d bde2020/spark-master:2.4.0-hadoop3.0

### Spark Worker
To start a Spark worker:

    docker run --name spark-worker-1 --link spark-master:spark-master -e ENABLE_INIT_DAEMON=false -d bde2020/spark-worker:2.4.0-hadoop3.0
